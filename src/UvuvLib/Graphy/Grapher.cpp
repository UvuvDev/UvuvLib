#include "UvuvLib/Graphy/Grapher.hpp"
...
void AsyncGrapher::insertNewGraph(std::pair<std::string, std::vector<double>>* newGraph) {    
    ...
    if (cnt > MAX_DATA) {
        ...
        colors.insert({newGraph->first, COLOR_CORNFLOWER_BLUE});
    }
